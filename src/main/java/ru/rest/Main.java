...
/**
 * TODO Таски на завтра:
 *      1) Надо зарендерить index.html при запуске сервера
 *      2) Нужно прописать весь crud функионал что бы этим можно было воспользоваться Для User и Order
 *      3) Нужно все это протестировать через JUnit
 *      Далее можно сдавать домашку
 */
